...
extension UIColor {
    ...
    //MARK: - Map
    static let mapHard = UIColor(red: 0.922, green: 0.314, blue: 0.137, alpha: 1)
    static let mapMedium = UIColor(red: 0.922, green: 0.702, blue: 0.082, alpha: 1)
    static let mapLight = UIColor(red: 0.392, green: 0.62, blue: 0.118, alpha: 1)
